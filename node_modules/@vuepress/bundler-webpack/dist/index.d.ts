...
interface StylePreprocessorLoaderOptions {
    additionalData?: string | ((content: string, loaderContext: LoaderContext<Record<string, any>>) => string);
    sourceMap?: boolean;
 ...
 */
type StylePreprocessorOptions<T extends Record<string, any> = Record<string, any>> = T | ((loaderContext: LoaderContext<T>) => TextDecodeOptions);
/**
